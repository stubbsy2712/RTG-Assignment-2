...
bool FireModelClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* context, char* modelFilename, char* textureFilename1,
	char* textureFilename2, char* textureFilename3)
{
	bool result;
	...
	result = LoadTextures(device, context, textureFilename1, textureFilename2, textureFilename3);
	if(!result)
	{
		return false;
	}
...
bool FireModelClass::LoadTextures(ID3D11Device* device, ID3D11DeviceContext* context, char* textureFilename1, char* textureFilename2, char* textureFilename3)
{
	bool result;
